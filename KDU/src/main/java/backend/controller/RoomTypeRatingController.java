...
public class RoomTypeRatingController {
    ...
    public String updateRating(
        ...
        if (transactions != null && !transactions.isEmpty()) {
            // Find the transaction that matches the roomTypeId
            for (BookingTransaction t : transactions) {
                if (t.getBookingDetails() != null) {
                    ...
                    if (confirmationDetails != null && confirmationDetails.has("roomTypeId")) {
        ...
        if (transaction != null && transaction.isHasReviewed()) {
            return """
                <!DOCTYPE html>
                <html>
                <head>
